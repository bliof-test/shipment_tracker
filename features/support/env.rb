...
# You may also want to configure DatabaseCleaner to use different strategies for certain features and
# scenarios. See the DatabaseCleaner documentation for details. Example:
#
