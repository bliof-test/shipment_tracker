...
Scenario: User finds deployed tickets by description
  ...
  Then I should find the following tickets on the dashboard:
    | Jira Key | Summary       | Description                       | Deploys                    |
    | ENG-3    | Another story | As a User implement another story | 2016-03-21 12:02 UTC app_1 |
    | ENG-2    | Another task  | As a User implement another task  | 2016-03-21 12:02 UTC app_1 |
...
Scenario: User finds tickets by deployed app name
  ...
  Then I should find the following tickets on the dashboard:
    | Jira Key | Summary     | Description | Deploys                    |
    | ENG-2    | Second task | Something   | 2016-03-21 12:02 UTC app_1 |
